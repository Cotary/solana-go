...
[![GoDoc](https://pkg.go.dev/badge/github.com/Cotary/solana-go?status.svg)](https://pkg.go.dev/github.com/Cotary/solana-go@v1.8.3?tab=doc)
[![GitHub tag (latest SemVer pre-release)](https://img.shields.io/github/v/tag/gagliardetto/solana-go?include_prereleases&label=release-tag)](https://github.com/Cotary/solana-go/releases)
[![Build Status](https://github.com/Cotary/solana-go/workflows/tests/badge.svg?branch=main)](https://github.com/Cotary/solana-go/actions?query=branch%3Amain)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/Cotary/solana-go/main)](https://www.tickgit.com/browse?repo=github.com/Cotary/solana-go&branch=main)
[![Go Report Card](https://goreportcard.com/badge/github.com/Cotary/solana-go)](https://goreportcard.com/report/github.com/Cotary/solana-go)
...
**If you're looking for a SERUM library, you can check out [gagliardetto/serum-go](https://github.com/gagliardetto/serum-go) ([./programs/serum](https://github.com/Cotary/solana-go/tree/main/programs/serum) is deprecated.**)
...
There is currently **no stable release**. The SDK is actively developed and latest is `v1.8.3` which is an `alpha` release.
...
```bash
$ cd my-project
$ go get github.com/Cotary/solana-go@v1.8.3
```
...
You can wait for a transaction confirmation using the `github.com/Cotary/solana-go/rpc/sendAndConfirmTransaction` package tools (for a complete example: [see here](#transfer-sol-from-one-wallet-to-another-wallet))
...
import (
	...
	lookup "github.com/Cotary/solana-go/programs/address-lookup-table"
	"github.com/Cotary/solana-go/rpc"
...
import (
  ...
  "github.com/Cotary/solana-go"
  "github.com/Cotary/solana-go/programs/system"
  "github.com/Cotary/solana-go/rpc"
...
import (
  ...
  "github.com/Cotary/solana-go/rpc"
  "github.com/Cotary/solana-go/rpc/jsonrpc"
)
...
import (
  ...
  "github.com/Cotary/solana-go/programs/system"
  "github.com/Cotary/solana-go/rpc"
  confirm "github.com/Cotary/solana-go/rpc/sendAndConfirmTransaction"
  "github.com/Cotary/solana-go/rpc/jsonrpc"
  "github.com/Cotary/solana-go/rpc/ws"
  "github.com/Cotary/solana-go/text"
)
...
import (
  ...
  "github.com/davecgh/go-spew/spew"
  bin "github.com/gagliardetto/binary"
  solana "github.com/Cotary/solana-go"
  "github.com/Cotary/solana-go/programs/token"
  "github.com/Cotary/solana-go/rpc"
)
